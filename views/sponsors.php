		<div id="sponsors">
			...
			<div class="container">
				<div class="row level-1">
					<div class="col-md-6">
						<a href="https://www.google.com/"><img alt="Google" src="../img/google-logo.png"></a>
					</div>
					<div class="col-md-6">
						<a href="https://www.edsurge.com/"><img alt="edSurge" src="../img/edsurge-logo.png"></a>
					</div>
				</div>
			</div>
...
<!-- 	<div id="owl-example" class="owl-carousel">
	  ...
	  <div><img src="./assets/img/clients/c03.gif" alt=""></div>
	  <div><img src="./assets/img/clients/c04.gif" alt=""></div>
	  <div><img src="./assets/img/clients/c05.gif" alt=""></div>
	  <div><img src="./assets/img/clients/c01.gif" alt=""></div>
	  <div><img src="./assets/img/clients/c02.gif" alt=""></div>
	</div>
